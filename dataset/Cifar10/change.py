...
for arquivo in arquivos:
    ...
    # Realize a substituição dos rótulos por valores aleatórios entre 0 e 9
    if 'images' in locals() and 'labels' in locals():
        labels_random = np.random.randint(0, 10, size=labels.shape)  # Gera valores aleatórios de 0 a 9
        ...
        dados_modificados['y'] = labels_random  # Substitua os rótulos pelos valores aleatórios
        ...
        print(f"Novos rótulos aleatórios (primeiros 10): {labels_random[:10]}")
